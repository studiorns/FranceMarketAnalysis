#!/usr/bin/env python3
"""
Convert France Enhanced Travel Queries Forecast CSV to Excel

This script converts the France Enhanced Travel Queries Forecast CSV file to Excel format,
...
if __name__ == "__main__":
    # Define paths
    csv_path = "Travel_Queries_Forecast_France_Enhanced.csv"
    excel_path = "Travel_Queries_Forecast_France_Enhanced.xlsx"
